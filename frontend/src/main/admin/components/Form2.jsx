...
function Form({ fields, url, successMessage, tablename, changeableFields, buttonName, tableKey }) {
    ...
    return (
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 md:gap-x-10 md:gap-y-1">
        ...
        <button onClick={handleSubmit} className="bg-blue-500 text-white py-0.5 px-3 rounded mr-5">
                {buttonName}
            </button>
            <button type="button" onClick={handleClear} className="bg-rose-500 text-white p-0.5 rounded w-28">
                Clear All
            </button>
