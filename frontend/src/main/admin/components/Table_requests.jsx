                            ...
                            <div className="table-header-group">
                                <div className="table-row">
                                    {headers.map((header, index) =>
                                        <div className="table-cell text-center px-4 py-2 bg-indigo-200 min-w-max" key={index}>{ header}</div>
                                    )}
                                </div>
                            </div>
                                ...
                                {data.map((row, rowIndex) => (
                                    ...
                                    >
                                        {headers.map((key, cellIndex) =>
                                            <div className="table-cell py-1 text-center select-none" key={cellIndex}> {row[key]} </div>
                                        )}
                                    </div>
                                ))}
                            </div>
