...
function AddLocation() {
    let fields = ['Location ID', 'Location Name', 'Address']
    ...
    async function handleSubmit() {
        if (validateForm()) {
            await axios.post('/api/new_location', formState, 
    ...
    return (
        <div>
            <h1 className="text-xl font-semibold mb-5">New Warehouse Location</h1>
